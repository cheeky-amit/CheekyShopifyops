...
This folder is for examples that span multiple skills (e.g., "weekly merchant brief" composing analytics + orders + inventory + catalog primitives).

Single-skill examples live inside each skill's own `examples/` folder.
