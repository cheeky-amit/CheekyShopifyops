# Contributor working contract

Read this before editing or adding skills. This is the engineering contract — the merchant-facing summary lives in [`docs/how-this-stays-safe.md`](../how-this-stays-safe.md) and the merchant operator's manual is the top-level [`CLAUDE.md`](../../CLAUDE.md).
...
- `SKILL.md` — agent-facing definition (frontmatter + workflow).
...
Frontmatter schema in [`conventions.md`](conventions.md).
...
Structural decisions are documented as ADRs in [`decisions/`](decisions/). Add a new ADR when changing folder layout, frontmatter schema, ID scheme, or skill inventory.
